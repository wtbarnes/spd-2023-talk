...
::: {.notes}
Replace this with my simulation/reconstruction of the DEM with only cool only lines
:::
...
::: aside
See talk by J. Duncan on Thursday, Session 406
:::
...
sl = np.s_[0, 330:400, 900:]
norm = ImageNormalize(vmin=0, vmax=4e3, stretch=LogStretch())
...
::: {.notes}
- one slide that shows the equations for the inversion and appropriate references
- one slide that shows three different inversion results (Ridge, LASSO, ElasticNet) with the "true" EM distributions overlaid
:::
...
- Inversion of MOXSI spectra **recovers hot (>4 MK) component of EM distribution**
- **Future:**
    - Further investigation of inversion models
    - Tuning hyperparameters to adjust sparsity, smoothness
    - Investigate more heating scenarios
